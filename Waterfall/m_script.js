    ...
    var appendCells = function(num) {
        ...
        request.onreadystatechange = function() {
            if(request.readyState == 4 && request.status == 200) {
                ...
                for(var j = 0, k = data.length; j < k; j++) {
                    ...
                    cell.className = 'cell';
                    cell.innerHTML = '<p><a href="#"><img src="http://qiurf.qiniudn.com/' + data[j].s + '.jpg" height="' + data[j].h + '" width="190" /></a></p><h2><a href="#">' + data[j].s + '.jpg</a></h2><span class="like">Like!</span><span class="mark">Mark!</span>';
                    cells.push(cell);
        ...
        */
        ...
        var fragment = document.createDocumentFragment(),
            cells = [],
            data = [],
            size =  size = [286, 143, 270, 143, 190, 285, 152, 275, 285, 285, 128, 281, 242, 339, 236, 157, 286, 259, 267, 137, 253, 127, 190, 190, 225, 269, 264, 272, 126, 265, 287, 269, 125, 285, 190, 314, 141, 119, 274, 274, 285, 126, 279, 143, 266, 279, 600, 276, 285, 182, 143, 287, 126, 190, 285, 143, 241, 166, 240, 190,286, 143, 270, 143, 190, 285, 152, 275, 285, 285, 128, 281, 242, 339, 236, 157, 286, 259, 267, 137, 253, 127, 190, 190, 225, 269, 264, 272, 126, 265, 287, 269, 125, 285, 190, 314, 141, 119, 274, 274, 285, 126, 279, 143, 266, 279, 600, 276, 285, 182, 143, 287, 126, 190, 285, 143, 241, 166, 240, 190];
        for(var i = 0; i < num; i++) {
        ...
        for(var j = 0, k = data.length; j < k; j++) {
            var cell = document.createElement('div');
            cell.className = 'cell';
            cell.innerHTML = '<p><a onclick="preview('+data[j].s+');" href="#"><img  src="http://qiurf.qiniudn.com/' + data[j].s + '.JPG" height="' + data[j].h + '" width="190"  /></a></p><h2><a href="#">' + data[j].s + '.JPG</a></h2><span class="like">Like!</span><span class="mark">Mark!</span>';
            cells.push(cell);
            fragment.appendChild(cell);
        }
        container.appendChild(fragment);
...
function preview(j){
	...
	preview.innerHTML='<a  href="#" id="close" onclick="close_Preview();">Close</a><img src="http://qiurf.qiniudn.com/'+j+'.JPG" width="600" height="500" id='+j+' /><div id="words"></div> ';
